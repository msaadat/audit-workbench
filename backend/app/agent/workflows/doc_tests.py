...
the auditor-owned checkpoint that no worker or deterministic executor satisfies.
...
WORKFLOW_ID = "doc_tests_workflow_v2"
...
TEMPLATE_OUTCOMES: dict[str, list[str]] = {
    ...
    "document_test_disposition": ["doc_tests.dispositioned"],
}
