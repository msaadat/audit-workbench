...
These workers own their prompt, their bounded bundle-to-message transformation,
and the part of the definition contract that can be decided from the supplied
context: response shape, enum membership, and reference existence against the
supplied table schemas and the application's own test catalogs.
