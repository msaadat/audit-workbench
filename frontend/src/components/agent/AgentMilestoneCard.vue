...
<style scoped>
.milestone{display:grid;grid-template-columns:1.7rem minmax(0,1fr);gap:.55rem;align-self:flex-start;width:min(92%,42rem);padding:.65rem .75rem;border:1px solid var(--aw-border);border-radius:var(--aw-radius-surface);background:var(--aw-canvas)}
.icon{display:grid;place-items:center;width:1.7rem;height:1.7rem;border-radius:var(--aw-radius-control);background:var(--aw-teal-soft);color:var(--aw-teal);font-size:var(--aw-text-xs)}
...
.body{display:grid;gap:.28rem;min-width:0}.body>strong{font-size:var(--aw-text-sm)}.body>p{margin:0;color:var(--aw-muted);font-size:var(--aw-text-xs);line-height:1.45}
.metrics{display:flex;flex-wrap:wrap;gap:.3rem .75rem;margin:.2rem 0 0}.metrics div{display:flex;gap:.25rem;font-size:var(--aw-text-2xs)}.metrics dt{color:var(--aw-muted)}.metrics dd{margin:0;font-weight:600}
.highlights{display:grid;gap:.25rem;margin:.25rem 0 0;padding:0;list-style:none}.highlights li{display:grid;grid-template-columns:.8rem minmax(0,1fr);gap:.35rem;color:var(--aw-warn);font-size:var(--aw-text-xs)}.highlights li[data-severity='error']{color:var(--aw-danger)}.highlights i{padding-top:.12rem;font-size:var(--aw-text-2xs)}.highlights span{display:grid}.highlights b{font-weight:600}.highlights small{color:var(--aw-muted);line-height:1.35}
