...
<style scoped>
.next-action { display: grid; grid-template-columns: auto minmax(0,1fr) auto; gap: .85rem; align-items: center; margin: 1rem 0; padding: 1rem; border: 1px solid var(--aw-info-line); border-radius: var(--aw-radius-control); background: var(--aw-info-soft); text-align: left; }
.next-action-icon { display: grid; place-items: center; width: 2.5rem; height: 2.5rem; border-radius: 50%; background: var(--aw-panel); color: var(--aw-teal); }
.next-action h4 { margin: .35rem 0 .2rem; }.next-action p { margin: 0 0 .25rem; color: var(--aw-ink-soft); }.next-action small { color: var(--aw-muted); }
.planning-confirmation { display: grid; gap: .8rem; }.planning-confirmation > p { margin: 0; line-height: 1.5; }
.context-preview { padding: .85rem; border: 1px solid var(--aw-warn-line); border-radius: var(--aw-radius-control); background: var(--aw-warn-soft); }.context-preview strong { display: flex; align-items: center; gap: .45rem; }.context-preview p { margin: .4rem 0; }.context-preview ul { margin: .55rem 0; padding-left: 1.25rem; }.context-preview li { margin: .2rem 0; }
.optin-note { display: flex; gap: .5rem; padding: .7rem; border-radius: var(--aw-radius-control); background: var(--aw-raised); color: var(--aw-ink-soft); }.optin-note i { color: var(--aw-teal); }
.inline-error { display: flex; gap: .45rem; padding: .65rem; color: var(--aw-danger); background: var(--aw-danger-soft); border-radius: var(--aw-radius-control); }
