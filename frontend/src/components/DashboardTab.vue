...
.dashboard-heading h2 { margin:0; font-size:var(--aw-text-xl) }
.dashboard-loading { display:flex; flex-direction:column; gap:1rem }
.onboarding-card { min-height:18rem; display:flex; flex-direction:column; justify-content:center; gap:2rem; padding:2.2rem; border:1px solid var(--aw-teal-line); border-radius:var(--aw-radius-surface); background:linear-gradient(135deg,var(--aw-panel) 45%,var(--aw-teal-soft));}
.onboarding-copy { display:flex; align-items:flex-start; gap:1.25rem; max-width:48rem }.onboarding-icon { display:grid; place-items:center; width:4rem; height:4rem; flex:none; border-radius:var(--aw-radius-surface); background:var(--aw-teal-soft); color:var(--aw-teal); font-size:var(--aw-text-2xl) }
...
.next-action-card { gap:1rem; padding:1rem 1.1rem; margin-bottom:1rem; border:1px solid var(--aw-teal-line); border-left:4px solid var(--aw-teal); border-radius:var(--aw-radius-surface); background:var(--aw-panel);}
.next-action-mark { display:grid; place-items:center; width:2.6rem; height:2.6rem; flex:none; border-radius:50%; background:var(--aw-teal-soft); color:var(--aw-teal) }.next-action-copy { flex:1 }.next-action-copy > span { color:var(--aw-teal); font-size:var(--aw-text-xs); font-weight:700;}.next-action-copy h3 { margin:.15rem 0 }.next-action-copy p { margin:0; color:var(--aw-muted); font-size:var(--aw-text-sm) }
.monitoring-section { margin-top:1rem }.section-heading { justify-content:space-between; gap:1rem; margin-bottom:.55rem }.section-heading h3 { margin:0; font-size:var(--aw-text-base) }
.dashboard-columns { display:grid; grid-template-columns:minmax(0,1.35fr) minmax(18rem,.65fr); align-items:stretch; gap: var(--aw-section-gap); margin-top:1rem }.work-card { display:flex; flex-direction:column; min-width:0; max-height:32rem; padding:1rem; overflow:hidden; border:1px solid var(--aw-border); border-radius:var(--aw-radius-control); background:var(--aw-panel);}.work-card > .section-heading { flex:none }.work-card-body { min-height:0; overflow-y:auto; scrollbar-gutter:stable }
.action-list,.attention-list { display:flex; flex-direction:column }.action-row,.attention-row { display:flex; align-items:flex-start; gap:.65rem; width:100%; padding:.65rem .25rem; border:0; border-bottom:1px solid var(--aw-border); background:transparent; color:inherit; text-align:left; cursor:pointer }.action-row:last-child,.attention-row:last-child { border-bottom:0 }.action-row:hover,.attention-row:hover { background:var(--aw-canvas) }.action-row > span:nth-child(2),.attention-row span { flex:1; display:flex; flex-direction:column; gap:.12rem }.action-row strong,.attention-row strong { font-size:var(--aw-text-sm) }.action-row small,.attention-row small { color:var(--aw-muted); font-size:var(--aw-text-xs); line-height:1.4 }.action-row > .pi-chevron-right { align-self:center; color:var(--aw-muted); font-size:var(--aw-text-2xs) }
.priority-dot { width:.48rem; height:.48rem; flex:none; margin-top:.3rem; border-radius:50%; background:var(--aw-border-strong) }.priority-dot[data-priority='high'] { background:var(--aw-danger) }.priority-dot[data-priority='medium'] { background:var(--aw-warn) }.priority-dot[data-priority='low'] { background:var(--aw-info) }
.ai-advice-head { justify-content:space-between; gap:1rem; margin-top:.85rem; padding-top:.85rem; border-top:1px solid var(--aw-border) }.ai-advice-head > div { display:flex; flex-direction:column }.ai-advice-head strong { font-size:var(--aw-text-sm) }.ai-advice-head small,.advice-note { color:var(--aw-muted); font-size:var(--aw-text-xs) }.advice-note,.advice-error { margin:.55rem 0 }.advice-error { color:var(--aw-danger); font-size:var(--aw-text-xs) }.advice-meta { gap:.45rem; margin-top:.55rem; color:var(--aw-muted); font-size:var(--aw-text-2xs) }.ai-list { margin-top:.25rem }.ai-mark { margin-top:.15rem; color:var(--aw-accent) }
.attention-row > i { margin-top:.15rem }.attention-row > i[data-severity='error'] { color:var(--aw-danger) }.attention-row > i[data-severity='warning'] { color:var(--aw-warn) }.compact-empty { display:flex; align-items:center; gap:.5rem; min-height:4rem; color:var(--aw-muted); font-size:var(--aw-text-sm) }.compact-empty i { color:var(--aw-ok) }
.monitoring-heading { align-items:flex-end }.tile-summary { display:flex; gap:.65rem; color:var(--aw-muted); font-size:var(--aw-text-xs) }.tile-summary .ok { color:var(--aw-ok) }.tile-summary .warn { color:var(--aw-warn) }.tile-summary .fail { color:var(--aw-danger) }
.pin-empty { display:flex; align-items:center; gap:.85rem; padding:1rem; border:1px dashed var(--aw-border); border-radius:var(--aw-radius-control); background:rgb(255 255 255 / 55%) }.pin-empty > i { color:var(--aw-teal); font-size:var(--aw-text-xl) }.pin-empty > div { flex:1 }.pin-empty strong { font-size:var(--aw-text-sm) }.pin-empty p { margin:.15rem 0 0; color:var(--aw-muted); font-size:var(--aw-text-xs) }
.tile-grid { display:grid; grid-template-columns:repeat(auto-fill,minmax(420px,1fr)); gap:1rem }.tile { min-width:0; padding:.9rem 1rem 1rem; border:1px solid var(--aw-border); border-top:3px solid var(--aw-border-strong); border-radius:var(--aw-radius-control); background:var(--aw-panel);}.tile[data-verdict='ok'] { border-top-color:var(--aw-ok) }.tile[data-verdict='warn'] { border-top-color:var(--aw-warn) }.tile[data-verdict='fail'] { border-top-color:var(--aw-danger) }.tile[data-verdict='info'] { border-top-color:var(--aw-info) }.tile-flash { animation:tile-flash 2.4s ease-out }@keyframes tile-flash { 0% { box-shadow:0 0 0 3px var(--aw-teal-line) } 100% { box-shadow:var(--aw-shadow-sm) } }.tile-error { border-color:var(--aw-danger-line) }
.tile-head { justify-content:space-between; align-items:flex-start; gap:.5rem }.tile-title { gap:.5rem; flex-wrap:wrap; min-width:0 }.tile-title i { color:var(--aw-teal-600) }.verdict-inline { display:flex; align-items:center; gap:.35rem; min-width:0 }.verdict-inline small { color:var(--aw-muted); font-size:var(--aw-text-sm); overflow:hidden; text-overflow:ellipsis; white-space:nowrap }.tile-actions { flex-shrink:0 }.tile:not(:hover) .tile-actions { opacity:.35 }.tile-actions { transition:opacity .15s }.tile-meta { margin:.15rem 0 .4rem; font-size:var(--aw-text-sm) }.tile-note { margin:0 0 .5rem; color:var(--aw-ink-soft); font-size:var(--aw-text-base); font-style:italic }.tile-stats { display:flex; flex-wrap:wrap; gap:.4rem 1.1rem; margin-bottom:.6rem }.tile-stat { display:flex; flex-direction:column }.tile-stat .label { color:var(--aw-muted); font-size:var(--aw-text-xs);}.tile-stat .value { font-size:var(--aw-text-md); font-weight:600 }.tile-error-body { display:flex; align-items:flex-start; gap:.5rem; padding:.75rem 0; color:var(--aw-danger); font-size:var(--aw-text-base) }.edit-note { margin-top:.75rem }
