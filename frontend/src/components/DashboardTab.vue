...
.pin-empty { display:flex; align-items:center; gap:.85rem; padding:1rem; border:1px dashed var(--aw-border); border-radius:var(--aw-radius-control); background:var(--aw-panel-wash) }.pin-empty > i { color:var(--aw-teal); font-size:var(--aw-text-xl) }.pin-empty > div { flex:1 }.pin-empty strong { font-size:var(--aw-text-sm) }.pin-empty p { margin:.15rem 0 0; color:var(--aw-muted); font-size:var(--aw-text-xs) }
